...
import type { Asset, AssetIdInnerType, BinaryId, BinaryMode, DepositNonce, OrderId, OrderSide, PoolId, PoolTokenIndex, ResourceId, SubAccType, TransferReason, XdotNumber } from '@equilab/api/genshiro/interfaces/latest';
