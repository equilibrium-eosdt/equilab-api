...
import type { Asset, AssetMetrics, BalancesAggregate, CapVec, Currency, DataPoint, DepositNonce, Duration, FinancialMetrics, FixedNumber, OperationRequest, PortfolioMetrics, Price, PriceLog, PricePayload, PricePeriod, PricePoint, PriceUpdate, ProposalStatus, ProposalVotes, ResourceId, SignedBalance, SubAccType, TotalAggregates, TransferReason, UserGroup } from '@equilab/api/equilibrium/interfaces/latest';
