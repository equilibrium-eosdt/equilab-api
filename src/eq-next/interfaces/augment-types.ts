...
import type { AmmPool, Asset, AssetData, AssetIdInnerType, AssetMetrics, AssetName, AssetType, BalancesAggregate, BestPrice, BinaryId, BinaryInfo, BinaryMode, CapVec, ChunkKey, Currency, DataPoint, DebtWeightType, DebtWeightTypeInner, DepositNonce, Duration, FinancialMetrics, FinancialRecalcPeriodMs, FixedNumber, LockPeriod, MarginState, MaxCountOfAssetsRecalcPerBlock, MmPoolInfo, Number, OperationRequest, OperationRequestDexDeleteOrder, OperationRequestLiqFm, Order, OrderId, OrderSide, OrderType, PoolId, PoolInfo, PoolTokenIndex, PortfolioMetrics, Price, PriceLog, PricePayload, PricePeriod, PricePoint, PriceUpdate, ProposalStatus, ProposalVotes, ResourceId, Round, SignedBalance, SubAccType, Timestamp, TotalAggregates, TransferReason, UnsignedPriorityPair, UserGroup, VestingParams, XdotNumber, XdotPoolInfo } from '@equilab/api/eq-next/interfaces/latest';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    AssetId: AssetId;
    AssetIdInnerType: AssetIdInnerType;
    ...
    BalanceOf: BalanceOf;
    BalancesAggregate: BalancesAggregate;
    ...
    Data: Data;
    DataPoint: DataPoint;
    DebtWeightType: DebtWeightType;
    DebtWeightTypeInner: DebtWeightTypeInner;
    ...
    FinancialRecalcPeriodMs: FinancialRecalcPeriodMs;
    Fixed128: Fixed128;
    Fixed64: Fixed64;
    FixedI128: FixedI128;
    FixedI64: FixedI64;
    ...
    MaxCountOfAssetsRecalcPerBlock: MaxCountOfAssetsRecalcPerBlock;
    ...
    OperationRequestDexDeleteOrder: OperationRequestDexDeleteOrder;
    OperationRequestLiqFm: OperationRequestLiqFm;
    Order: Order;
    OrderId: OrderId;
    OrderSide: OrderSide;
    OrderType: OrderType;
    ...
    UnsignedPriorityPair: UnsignedPriorityPair;
    ...
    XdotNumber: XdotNumber;
    XdotPoolInfo: XdotPoolInfo;
  } // InterfaceTypes
} // declare module
